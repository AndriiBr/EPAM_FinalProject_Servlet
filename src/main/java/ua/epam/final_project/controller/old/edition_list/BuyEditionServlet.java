...
public class BuyEditionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<UserEdition> userEdition = userEditionService.findAllUserEditionByUserIdEditionId(userDto, edition);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            UserDto userDto = userService.findUserByLogin(login);
            Edition edition = editionService.findEditionById(editionId);
            if (userEditionService.insertUserEdition(userDto, edition)) {
