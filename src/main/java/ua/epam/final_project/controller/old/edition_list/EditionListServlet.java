package ua.epam.final_project.controller.old.edition_list;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (login == null) {
            ...
            try {
                ...
                editionList = editionService.findAllEditionsFromTo(userDto, false, recordsPerPage, page, genreFilter, orderBy);
                noOfRecords = editionService.getNumberOfEditions(userDto, false, genreFilter);
                genreList = genreService.findAllGenres();
                forwardToPage(req, resp, page, noOfRecords, recordsPerPage, editionList, genreList);
