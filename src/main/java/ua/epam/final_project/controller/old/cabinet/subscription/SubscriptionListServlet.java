...
public class SubscriptionListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            editionList = editionService.findAllEditionsFromTo(userDto, true, recordsPerPage, page, genreFilter, orderBy);
            noOfRecords = editionService.getNumberOfEditions(userDto, true, genreFilter);
