...
public interface IEditionDao {
     ...
     */
    Integer getNumberOfEditions(int genreFilter) throws DataNotFoundException;
     ...
     * @throws DataNotFoundException if nothing was found in Db
     */
    Integer getNumberOfEditions(User user, boolean has, int genreFilter) throws DataNotFoundException;
     ...
     * @throws DataNotFoundException if nothing was found in Db
     */
    List<Edition> findAllEditionsFromTo(int recordsPerPage, int page, int genreFilter, String orderBy) throws DataNotFoundException;
     ...
     * @throws DataNotFoundException if nothing was found in Db
     */
    List<Edition> findAllEditionsFromTo(User user, boolean has, int recordsPerPage, int page, int genreFilter, String orderBy) throws DataNotFoundException;
