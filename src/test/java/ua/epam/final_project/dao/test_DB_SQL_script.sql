...
values ('edition1', 'edition1', '', 1, 100);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition2', 'edition2', '', 1, 200);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition3', 'edition3', '', 1, 300);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition4', 'edition4', '', 1, 400);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition5', 'edition5', '', 2, 500);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition6', 'edition6', '', 2, 600);
insert into edition (title_en, title_ua, title_image, genre_id, price)
values ('edition7', 'edition7', '', 2, 700);
